...
3. Push workspace to MinIO **before** sending the request:
   ...
   ```
4. Generate a precise coding prompt (see the relevant skill in your `skills/` directory) and send `coding-request:` to Manager
...
Full guidance: read the relevant skill's `SKILL.md` in your `skills/` directory.
